...
namespace UnityEditor.AI
{
    ...
    [CustomEditor(typeof(NavMeshSurfaceNBLD))]
    class NavMeshSurfaceEditorNBLD : Editor
    {

        SerializedProperty m_CollectBoth;
        ...
        void OnEnable()
        {
            ...
            m_CollectBoth = serializedObject.FindProperty("m_CollectBoth");
        ...
        Bounds GetBounds()
        {
            var navSurface = (NavMeshSurfaceNBLD)target;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_CollectBoth);
            EditorGUILayout.Space();
            ...
            foreach (NavMeshSurfaceNBLD navSurface in targets)
            {
                ...
                if (navSurface.collectObjects == CollectObjectsNBLD.Volume)
                {
            ...
            using (new EditorGUI.DisabledScope(Application.isPlaying || m_AgentTypeID.intValue == -1))
            {
                ...
                {
                    NavMeshAssetManagerNBLD.instance.ClearSurfaces(targets);
                    SceneView.RepaintAll();
                }

                if (GUILayout.Button("Bake"))
                {
                    NavMeshAssetManagerNBLD.instance.StartBakingSurfaces(targets);
                }
                ...
                if (GUILayout.Button("Rotate Surface to XY"))
                {
                    ...
                    {
                        var o = item as NavMeshSurfaceNBLD;
            ...
            var bakeOperations = NavMeshAssetManagerNBLD.instance.GetBakeOperations();
        ...
        static void RenderBoxGizmoSelected(NavMeshSurfaceNBLD navSurface, GizmoType gizmoType)
        {
            RenderBoxGizmo(navSurface, gizmoType, true);
        }

        [DrawGizmo(GizmoType.NotInSelectionHierarchy | GizmoType.Pickable)]
        static void RenderBoxGizmoNotSelected(NavMeshSurfaceNBLD navSurface, GizmoType gizmoType)
        {
        ...
        static void RenderBoxGizmo(NavMeshSurfaceNBLD navSurface, GizmoType gizmoType, bool selected)
        {
        ...
        public static void CreateNavMeshSurface(MenuCommand menuCommand)
        {
            ...
            go.AddComponent<NavMeshSurfaceNBLD>();
